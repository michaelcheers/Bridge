    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1241", {
        ...
        statics: {
            methods: {
                TestMarkElement: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1241).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1241, 4, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestMarkElement()", $t.Line = "11", $t));
        ...
        methods: {
            GetContext: function () {
                var $t;
                if (this.context == null) {
                    this.context = ($t=new Bridge.Test.Runtime.FixtureContext(), $t.Project = "Batch3", $t.ClassName = "Bridge.ClientTest.Batch3.BridgeIssues.Bridge1241", $t.File = "Batch3\\BridgeIssues\\1200\\N1241.cs", $t);
                }
                return this.context;
            }
        }
        ...
        statics: {
            methods: {
                TestObjectLiteralPropertyImplementingInterface: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge1530).BeforeTest(true, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge1530, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestObjectLiteralPropertyImplementingInterface()", $t.Line = "22", $t));
        ...
        statics: {
            methods: {
                TestBridgeFields: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2310).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2310, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestBridgeFields()", $t.Line = "90", $t));
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2430", {
        ...
        statics: {
            methods: {
                TestPropertyInitializer: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2430).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2430, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestPropertyInitializer()", $t.Line = "53", $t));
    ...
    Bridge.define("Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2497", {
        ...
        statics: {
            methods: {
                TestPropertyInitializerWithDirective: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2497).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2497, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestPropertyInitializerWithDirective()", $t.Line = "196", $t));
        ...
        statics: {
            methods: {
                TestFieldInitialization: function (assert) {
                    var $t;
                    var t = Bridge.Test.Runtime.TestFixture$1(Bridge.ClientTest.Batch3.BridgeIssues.Bridge2745).BeforeTest(false, assert, Bridge.Test.Runtime.BridgeClientTestBatch3Runner.Bridge2745, void 0, ($t=new Bridge.Test.Runtime.TestContext(), $t.Method = "TestFieldInitialization()", $t.Line = "33", $t));
